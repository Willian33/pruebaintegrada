...
<html>
	...
	<body>
		<a href="#edit-subCategoria" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-subCategoria" class="content scaffold-edit" role="main">
